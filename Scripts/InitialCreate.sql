...
CREATE TABLE [PedidosItens] (
    ...
    CONSTRAINT [FK_PedidosItens_Produtos_IdPedido] FOREIGN KEY ([IdPedido]) REFERENCES [Produtos] ([Id]) ON DELETE CASCADE
);
...
VALUES (N'20200918180858_InitialCreate', N'3.1.8');

GO

ALTER TABLE [PedidosItens] DROP CONSTRAINT [FK_PedidosItens_Produtos_IdPedido];
...
ALTER TABLE [PedidosItens] ADD CONSTRAINT [FK_PedidosItens_Produtos_IdProduto] FOREIGN KEY ([IdProduto]) REFERENCES [Produtos] ([Id]) ON DELETE CASCADE;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20200918183049_AlterTablePedidositens', N'3.1.8');
